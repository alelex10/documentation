...
# Datos de durso a repasar

- it y test son lo mismo, son mas un alias
- para las descripciones en los parametros de test o it
  - usamos como regla general "accion a realizar(it)", "condiciones esperadas (when o with)" y "resultado esperado (expect)"
